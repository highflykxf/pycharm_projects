...
def gen_user_pro_cross_feature(dates_list, user_id_str, sku_id_str):
    ...
    for date_day in dates_list:
        ...
        if key in user_to_brand_six_behavior:
...
def gen_age_pro_cross_feature(dates_list, user_id_str, sku_id_str):
    ...
    if(user_id_str not in users_info):
    ...
    for date_day in dates_list:
        ...
        if(pro_key in view_product_to_age):
        ...
        if(pro_key in add_product_to_age):
        ...
        if(pro_key in del_product_to_age):
        ...
        if(pro_key in pur_product_to_age):
        ...
        if(pro_key in follow_product_to_age):
        ...
        if(pro_key in click_product_to_age):
        ...
        if(brand_key in view_brand_to_age):
        ...
        if(brand_key in add_brand_to_age):
        ...
        if(brand_key in del_brand_to_age):
        ...
        if(brand_key in pur_brand_to_age):
        ...
        if(brand_key in follow_brand_to_age):
        ...
        if(brand_key in click_brand_to_age):
...
def gen_sex_pro_cross_feature(dates_list, user_id_str, sku_id_str):
    ...
    for date_day in dates_list:
        ...
        if(pro_key in view_product_to_sex):
        ...
        if(pro_key in add_product_to_sex):
        ...
        if(pro_key in del_product_to_sex):
        ...
        if(pro_key in pur_product_to_sex):
        ...
        if(pro_key in follow_product_to_sex):
        ...
        if(pro_key in click_product_to_sex):
        ...
        if(brand_key in view_brand_to_sex):
        ...
        if(brand_key in add_brand_to_sex):
        ...
        if(brand_key in del_brand_to_sex):
        ...
        if(brand_key in pur_brand_to_sex):
        ...
        if(brand_key in follow_brand_to_sex):
        ...
        if(brand_key in click_brand_to_sex):
