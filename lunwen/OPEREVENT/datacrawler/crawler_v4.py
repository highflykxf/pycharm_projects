...
if __name__ == "__main__":
    ...
    useful_col = [u'ti_d', u'a1_name', u'a2_name',
                  u'a1_type1', u'a2_type1', u'a1_geo_fullname',
                  u'a2_geo_fullname', u'ac_goldsteinscale',
    ...
    for i, fn in enumerate(files_data_existing_csv, start=1):
        if index_e < start_num_e:
            index_e += 1
            continue
        output_child_path = os.path.join(output_path, fn[0:9])
        ...
        # daily_news_path = os.path.abspath(os.path.join(output_child_path, "daily_news.tsv"))
        # if os.path.isfile(daily_news_path) is True:
        #     shutil.rmtree(daily_news_path, True)
        ...
        export_to_csv(df_col_filter,
                      ex_filename=os.path.join(output_child_path, "daily_news.tsv"),
                      sep='\t',
                      escapechar="'",
                      index=False)
