    ...
    for data_folder in data_folders:
        ...
        for max_dist in range(10, 11, 1):
            ...
            for key in clusters:
                ...
                df_dailynews_first_cluster.loc[news_order[id_medoids] - 1, 'clust_mediod'] = int(cluster_id)
